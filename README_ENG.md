...
* **Browse saves** - view and manually delete game save data for all games.
...
* **b** - BASE - the base game itself
* **u** - Update - update installed
* **d** - DLC - DLC installed
* **l** - LayeredFS mod - LayeredFS mods or cheats for the game were detected in atmosphere/contents/
...
To turn off the MTP server and exit to the main menu, press the **X** or **B** button.
...
* **TurnOffScreen** - the option to automatically turn off the screen when MTP mode is activated
